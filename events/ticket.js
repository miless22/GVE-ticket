            ...
            if (interaction.customId === 'ticket_type_modal') {
                ...
                if (ticketType === 'gs') {
                    ...
                    permissionOverwrites = [
                        {
                            id: '1294281703426228345', // Role ID for gs tickets
                            allow: ['ViewChannel'],
                        },
                        {
                    ...
                    permissionOverwrites = [
                        {
                            id: '1294281454376980540', // Role ID for mr tickets
                            allow: ['ViewChannel'],
                        },
                        {
                            id: interaction.user.id, // Ticket opener
        ...
        if (interaction.customId === 'create_ticket') {
            ...
            collector.on('collect', async (i) => {
                ...
                const userEmbed = new EmbedBuilder()
                    ...
                    .setThumbnail("https://cdn.discordapp.com/icons/1294279351629516842/bbab831a44bb08cff095ec6978bfecef.png?size=4096")
                    .setDescription(`Hello <@${i.user.id}> your ticket has been successfully closed, we hope our staff team was able to help you with your question or issue. If you feel like we didn't do well enough you can open a ticket again.`);
